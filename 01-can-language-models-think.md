...
A certain researcher [cite] stated that his personal test was whether or not language models understood his jokes; now they do. (He seems somewhat worried, therefore, that AI might kill us all; we will save this question for a later document.) Anyone who had such a litmus test, which boiled down to the model understanding English, has probably seen it passed recently by contemporary models. If they haven't, they will soon.
